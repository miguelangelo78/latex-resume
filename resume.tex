...
\cvitem{\textbf{Frameworks:}}{NodeJs, Angular, Next.js, NestJS, .NET}
\cvitem{\scriptsize\textbf{DevOps \& Cloud:}}{AWS, Docker, CI/CD, Azure DevOps}
\cvitem{\textbf{Databases:}}{PostgreSQL, SQL Server}
\cvitem{\textbf{Search \& AI:}}{OpenSearch, GraphQL, AI integration}
...
\cvitem{\textbf{Structura:}}{Meta programming language for structured AI prompts. {\color{mydarkblue}\href{https://github.com/miguelangelo78/structura}{GitHub}}}
}
